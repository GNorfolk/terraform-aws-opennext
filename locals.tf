...
locals {
  ...
  server_options = {
    ...
    function = {
      ...
      runtime                        = coalesce(try(var.server_options.function.runtime, null), var.default_runtime)
    ...
    networking = {
      ...
      security_group_id            = try(var.server_options.networking.security_group_id, null)
  ...
  image_optimization_options = {
    ...
    function = {
      ...
      runtime                        = coalesce(try(var.image_optimization_options.function.runtime, null), var.default_runtime)
    ...
    networking = {
      ...
      security_group_id            = try(var.image_optimization_options.networking.security_group_id, null)
  ...
  revalidation_options = {
    ...
    function = {
      ...
      runtime                        = coalesce(try(var.revalidation_options.function.runtime, null), var.default_runtime)
    ...
    networking = {
      ...
      security_group_id            = try(var.revalidation_options.networking.security_group_id, null)
  ...
  warmer_options = {
    ...
    function = {
      ...
      runtime                        = coalesce(try(var.warmer_options.function.runtime, null), var.default_runtime)
    ...
    networking = {
      ...
      security_group_id            = try(var.warmer_options.networking.security_group_id, null)
